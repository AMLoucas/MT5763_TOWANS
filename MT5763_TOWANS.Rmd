...
``` {r, echo = FALSE, message = FALSE, fig.align = "centre", fig.cap = "Plot showing how the number of matches varies as a function of p. Each point represents the average number of matches played over 10000 tournament replicates for each p. Overlain is the (blue) curve fitted to the data"}
...
# Parallelise to increase efficiency 
