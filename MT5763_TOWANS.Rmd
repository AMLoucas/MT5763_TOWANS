...
We also estimated the parameter estimates and confidence intervals for the original data. We fitted one regression model on the original data using `PROC GLM`, the results of these command provides us with the estimates and the confidence intervals. 
