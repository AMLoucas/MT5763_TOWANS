...
### 4.2.1 Tournament Simualtion Contrusction
...
### Task Outcomes
For each task, we implemented the adequate code in R or SAS to produce the required deliverable and draw conclusions abbout the techniques investigated.
